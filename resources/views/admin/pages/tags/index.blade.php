  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      ...
      <div class=" float-right m-0">
        <a href="{{ route('admin.tag.create') }}" class="btn btn-success btn-sm">
            ...
            <div class="table-responsive"> 
              <table class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <span class="badge badge-pill {{ $tag->color }}">{{ $tag->name }}</span>
                    </td>
                    <td>{{ $tag->created_at }}</td>
                    <td class="text-center table-column-controls">
                      <a href="{{ Route('admin.tag.edit', $tag) }}" class="btn btn-success">
                        {{ __('Uredi') }}
                      </a>
