...
@section('content')
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body"> 
      ...
      <form action="{{ Route('admin.shop.store') }}" method="POST" id="newShop" autocomplete="off" enctype="multipart/form-data">
        <div class="form-group">
          <label for="shop_title" class="col-form-label">{{ ('Naziv') }}</label>
          <label for="shop_title" class="label-required">{{ ('(obavezno)') }}</label>
          <input id="shop_title" type="text" class="form-control" placeholder="Naziv ili lokacija prodavnice" name="shop_title" maxlength="128">
        </div>  
        <div class="form-group">
        ...
        <div class="mt-2">
          <button type="button" id="submit-button" form="newShop" class="btn btn-secondary">Kreiraj</button>
        </div>
      </form>
    </div>  
  </div>
