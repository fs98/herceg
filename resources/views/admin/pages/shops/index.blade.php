...
@section('content')
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">{{ __('Prodavnice') }}</h1> 

  {{-- Breadcrumb --}}
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb"> 
      <li class="breadcrumb-item active" aria-current="page">{{ __('Prodavnice') }}</li>
    </ol>
  </nav>
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-success align-middle">{{ __('Sve prodavnice') }}</h6>
        ...
        @forelse ($shops as $shop)
            ...
            <div class="col-12 col-md-3 col-lg-2">
              <div class="card" style="height: 22rem">
                <img class="card-img-top" style="height: 60%; object-fit: cover" src="{{ $shop->header_image_url }}" alt="Card image cap">
                <div class="card-body bg-light text-center d-flex flex-column justify-content-center">
                  <h5 class="card-title">{{ $shop->location }}</h5>
                  <div>
                    <a href="{{ Route('admin.shop.edit', $shop) }}" class="btn btn-success">
                      {{ __('Uredi') }}
                    </a>
                    <form action="{{ Route('admin.shop.destroy', $shop) }}" method="POST" class="d-inline-block">
                      @csrf
        ...
        @empty
            ...
            <div class="col-12">
              <div class="alert alert-danger w-100" role="alert">
                U bazi podataka trenutno nemate ni jednu prodavnicu.
              </div>
            </div>
