             ...
             <div class="card text-dark p-0 border-0 h-100 shadow-lg bg-light">
              ...
              <div class="card-img-overlay px-0">
                ...
                <div class="flex-column align-items-center position-absolute bottom-0 w-100 animated-card-buttons">
                  <div class="mb-4">
                    <a class="btn btn-dark rounded-0 px-3 py-3" href="{{ Route('public.products.show', ['category' => $product->category, 'product' => $product->slug]) }}" title="Vidi detaljno"><i class="fas fa-lg fa-search rounded"></i></a>
                  </div>
