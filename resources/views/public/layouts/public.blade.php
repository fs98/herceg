      ...
      <section id="middleHeader">
        <div class="container-fluid">
          <div class="row align-items-center justify-content-center my-3">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 d-flex order-0 order-md-0 order-xl-0"> 
              <div class="">
                <div id="logoIcon">
            ...
            <div class="d-none d-md-block col-xl-2 col-12 col-md-4 col-lg-3 order-2 order-xl-1 order-lg-1 justify-content-end justify-content-lg-start">
            ...
            <div class="col-12 col-md-8 col-lg-4 col-xl-5 p-3 p-sm-3 p-md-3 p-lg-0 order-2 order-md-1 order-xl-1 justify-content-end" id="search">
            ...
            <div class="col-lg-2 col-md-4 col-4 order-1 order-xl-2 order-lg-3 order-md-3 shopping-cart d-flex justify-content-end">
            ...
            <!-- Button for toggle menu on mobile version -->

            <div class="col-lg-1 col-md-4 col-2 order-1 order-md-4 d-lg-none">
              <button class="menu navbar-toggler order-1 justify-content-center ml-auto" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation" onclick="this.classList.toggle('opened');this.setAttribute('aria-expanded', this.classList.contains('opened'))">
                <svg width="60" height="45" viewBox="0 0 100 100">
